...
func run() int {
	...
	flag.Usage = func() {
		...
		fmt.Fprintln(os.Stderr, "                       (default: /etc/pgedge/config.yaml, then executable dir)")
		fmt.Fprintln(os.Stderr, "  -v, --version        Print version and exit")
		fmt.Fprintln(os.Stderr, "  -h, --help           Print help and exit")
		fmt.Fprintln(os.Stderr, "")
		fmt.Fprintln(os.Stderr, "Examples:")
		fmt.Fprintln(os.Stderr, "  mcp-bridge                         # Uses config.yaml from /etc/pgedge or executable dir")
